...
<img src="./fm1.jpg" width="120" height="120"> <p><strong>FM Nicaragua</strong> o <strong>FEDERICO MAHORA</strong>, es una marca de perfumes creados con la colaboración de <strong>Perfand</strong> y <strong>Drom Fragrances</strong> en Polonia, con un gran impacto de mercado en Europa. En <strong>Nicaragua</strong>, lleva 4 años dentro del mercado nacional teniendo una gran aceptación debido a la relación <strong>calidad/precio</strong> de nuestros productos, ofreciendo la máxima calidad a un precio accesible, razón por la cual hemos decidido darnos a conocer a través de plataformas digitales, incorporándonos a la nueva forma en la que se mueve y se conecta el mundo. Estamos muy contentos con los resultados, nos ha permitido interactuar con muchas personas, nuevos mercados interesados en distribuir nuestras fragancias.</p>
